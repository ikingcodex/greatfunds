                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
										...
										<?php if (!($user->is_blocked())){ ?>
										<div class="noticee">
											Having any difficulties?, contact our support team <a href="mailto:support@openpayonline.com?subject=inCycle">support@openpayonline.com</a>, OR send your complaints to our official whatsapp number <b>09026309626</b>
										</div>
										<?php } ?>
                </div>
            </div>
