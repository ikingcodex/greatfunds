          ...
          <div class="container">
              ...
              <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  <ul class="nav navbar-nav navbar-right">
                      <li>
                          <a class="page-scroll" href="#download">Discover</a>
                      </li>
                      <li>
          ...
          <div class="container">
              <div class="row">
                  <div class="col-md-8 col-md-offset-2">
                      ...
                      <h3>Go live and chat with everybody in our community forum, find out their experiences and see why they prefer to work with us. Chat live with our support team and tell us any issue you may have encountered while using our platform.</h3>
                  </div>
              </div>
          </div>
      </section>
                          ...
                          <div class="row">
                              <div class="col-md-6">
                                  <div class="feature-item">
                                      ...
                                      <h3>Register</h3>
                                      <p class="text-muted">Click sign-up and register with us to make 100% on investment placed. Fill in all the form fields required and a unique username which will help us identify you.</p>
                                  </div>
                              </div>
                              <div class="col-md-6">
                                  <div class="feature-item">
                          ...
                          <div class="row">
                              <div class="col-md-6">
                                  <div class="feature-item">
                                      ...
                                      <h3>Confirm</h3>
                                      <p class="text-muted">Once you've been paired to whom you are to pay to, call or send your teller, reciept, or bank application screengrab as proof of payment and confirmation to the person which you are paired with. </p>
                                  </div>
                              </div>
                              <div class="col-md-6">
                                  <div class="feature-item">
                                      ...
                                      <h3>Payment</h3>
                                      <p class="text-muted">As soon as the paired user confirms your payment, you'll instantly be moved to the list of those that get ₦50,000 within two days. Invite more people to keep the fun going non-stop</p>
                                  </div>
                              </div>
                          </div>
                      </div>
